...
### Full-Stack Developer | NASA Intern | Cybersecurity Enthusiast
...
Experienced engineering professional with a background in managing large-scale infrastructure projects. Successfully delivered projects on time and under budget with zero safety violations. Eager to leverage technical and leadership skills to drive successful outcomes.
...
### Cybersecurity
![NIST](https://img.shields.io/badge/NIST_800--53-0052CC?style=for-the-badge&logo=shield&logoColor=white)
![CIS](https://img.shields.io/badge/CIS_Benchmarks-FF6B6B?style=for-the-badge&logo=shield-check&logoColor=white)
...
![Indoor Wireman](https://img.shields.io/badge/Indoor_Wireman-IBEW-FFD700?style=for-the-badge&logo=tools&logoColor=black)
...
- Built the PC NASA ASCEND website and security framework
- Utilized Fusion360, Arduino coding, flight sensors, embedded systems, and data processing

### 🏢 Furulie LLC | Founder
*Oct 2025 – Present*

- Architected Next.js/TypeScript frontend, secure API, and backend services
- Built DevOps pipelines (CI/CD, IaC), integrated Stripe and identity systems
- Enforced cybersecurity policies (IAM, rate limiting, secret rotation)
- Oversaw observability (logs, SLOs, metrics) and production releases

### 🎓 Maricopa Community Colleges | IT Intern
*Sep 2025 – Present*

- Supported secure infrastructure and 24/7 datacenters via Tanium, CrowdStrike, Cloudflare
- Conducted vulnerability scans and integrated IAM
- Helped enforce NIST/CIS compliance across departments
...
- 👯 Open to collaboration on embedded systems and full-stack projects
- 💬 Ask me about: NASA projects, embedded systems, cybersecurity, or construction project management
- ⚡ Fun fact: I'm a licensed student pilot and former electrician apprentice!
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/preston-furulie/)
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=flat-square&logo=github&logoColor=white)](https://github.com/PrestonFurulie)
[![Email](https://img.shields.io/badge/Email-pfurulie@gmail.com-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:pfurulie@gmail.com)
